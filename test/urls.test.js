...
test('source identifies Google Flow share links on both hosts', () => {
  assert.strictEqual(U.source('https://labs.google/fx/tools/flow/shared/video/be83e530-cac3-43ed-90e4-77dfe9efe1ec').key, 'flow');
  assert.strictEqual(U.source('https://flow.google.com/shared/video/c2c6c14b-da90-4356-a83a-37413b4eb6ee').key, 'flow');
});
