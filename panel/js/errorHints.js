...
var RULES = [
  // Flow first: flow.google.com / labs.google appear only in Google Flow
  // failures, so a failed fetch there means the link isn't a public Share link
  // (unshared, deleted, or an editor/project URL) — not a cookie/extractor
  // problem the generic rules below would mis-diagnose.
  { re: /flow\.google\.com|labs\.google/i,
